 ...
 * 
 */
package microservices.book.testutils.steps;
...
public class MultiplicationFeatureSteps {
	...
	public void the_user_sends_right_attempts(final String userAlias, final int attempts, final String rightOrWrong)
			throws Throwable {
	...
	public void the_user_gets_a_response_indicating_the_attempt_is_right(final String rightOrWrong) throws Throwable {
	...
	public void the_user_gets_points_for_the_attempt(int points) throws Throwable {
		long attemptId = lastAttemptResponse.getAttemptId();
		Thread.sleep(2000);
	...
	public void the_user_gets_the_badge(String badgeType) throws Throwable {
		long userId = lastAttemptResponse.getUserId();
		Thread.sleep(200);
